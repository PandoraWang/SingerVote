...
contract Ballot {
    ...
    function getState() public view returns(Phase State){
        State = state;
    }

    function getVoter(address voter) public view returns(uint prevote, uint finalvote){
        prevote = voters[voter].prevoted;
        finalvote = voters[voter].finvoted;
    }
